...
-- No INSERT or UPDATE policies are intentionally granted on either table.
-- Authenticated clients can read permitted data and delete their own threads,
-- while all AI/user message writes go through the service-role Edge Function.
