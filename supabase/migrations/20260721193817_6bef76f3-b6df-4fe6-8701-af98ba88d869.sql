-- 20260720123000_archive_retired_gamification.sql
begin;
...
begin
  ...
  loop
    execute format('revoke all on function %s from public, anon, authenticated', retired_function.signature);
  end loop;
end;
$$;
commit;

-- 20260720124000_generic_new_user_flow.sql
begin;
...
-- 20260720125000_atomic_poll_creation.sql
begin;
