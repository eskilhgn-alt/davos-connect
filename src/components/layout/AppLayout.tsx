 ...
 * `LocationSharingProvider`, som monteres på APP-ROT (App.tsx) slik at en
 * aktiv deling overlever navigasjon mellom faner — inkludert Chat, som har
 * eget layout utenfor dette treet.
 */
